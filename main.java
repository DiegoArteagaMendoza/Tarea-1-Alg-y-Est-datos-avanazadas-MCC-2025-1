...
public class main {
    public static void main(String[] args) {
        ...
        alg2.ejecutar(size, mode, "ascendente"); // Cambia a "pocas" o "muchas" según quieras
        alg3.ejecutar(size, mode); // Cambia a "pocas" o "muchas" según quieras
        tec.close();
    }
}
...
// !"descendente".equalsIgnoreCase(sentido)) {
